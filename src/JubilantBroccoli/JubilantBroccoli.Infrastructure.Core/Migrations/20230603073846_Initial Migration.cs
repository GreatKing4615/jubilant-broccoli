    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    Name = table.Column<string>(type: "character varying(3000)", maxLength: 3000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    Address = table.Column<string>(type: "character varying(3000)", maxLength: 3000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantsId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemRestaurant", x => new { x.ItemsId, x.RestaurantsId });
                    table.ForeignKey(
                        name: "FK_ItemRestaurant_Items_ItemsId",
                        column: x => x.ItemsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliverType = table.Column<int>(type: "integer", maxLength: 300, nullable: false),
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", maxLength: 300, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderedItemId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemOptions_OrderedItems_OrderedItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ItemOptionsId = table.Column<string>(type: "text", nullable: false),
                    ItemsId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemItemOption", x => new { x.ItemOptionsId, x.ItemsId });
                    table.ForeignKey(
                        name: "FK_ItemItemOption_ItemOptions_ItemOptionsId",
                        column: x => x.ItemOptionsId,
                        principalTable: "ItemOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemItemOption_Items_ItemsId",
                        column: x => x.ItemsId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemItemOption_ItemsId",
                table: "ItemItemOption",
                column: "ItemsId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemOptions_Name",
                table: "ItemOptions",
                column: "Name");

            migrationBuilder.CreateIndex(
                name: "IX_ItemOptions_OrderedItemId",
                table: "ItemOptions",
